# Spring PetClinic Sample Application [![Build Status]([![Java CI with Maven](https://github.com/iamjules4/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/iamjules4/spring-petclinic/actions/workflows/maven.yml)
